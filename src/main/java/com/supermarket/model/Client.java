...
public class Client extends Person {
    ...
    public Client(int id, String name, int age, int telephone, String address, LocalDate startDate,
            double purchaseAmountInMonth, String favProduct, LocalDate birthday) {
