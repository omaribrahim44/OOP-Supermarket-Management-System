...
import com.supermarket.dao.InvoiceDAO;
...
public class Supermarket {
    ...
    public int sellProduct(List<Product> products, List<Integer> quantities, Client client, Staffmember staffmember,
        ...
        for (int i = 0; i < products.size(); i++) {
            ...
            // Expiration check removed as field was removed from Product model
            /*
            ...
            double initialPrice = product.getPrice() * quantity;
        ...
        Invoice invoice = new Invoice(LocalDate.now().toString(), LocalDate.now().toString(), totalInitialPrice,
                finalPrice, totalDiscount, staffmember.getId(), pointOfSale.getId(), totalSoldQuantity, products,
                quantities);
        addInvoices(invoice);
        ...
        client.setPurchaseAmountInMonth(
                client.getPurchaseAmountInMonth() + (int) (totalSoldQuantity * totalInitialPrice));
